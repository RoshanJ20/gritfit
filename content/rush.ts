  ...
  formats: [
    ...
    },
    {
      ...
      paras: [
        ...
        "Taekwondo is more than a martial art. We train control. We build confidence. We sharpen technique and develop the discipline to keep progressing.",
        "Through structured sessions, we work on mobility, speed, coordination, technique and mental focus. Every movement has purpose. Every session builds awareness, resilience and respect.",
        "Whether you’re stepping onto the mat for the first time or looking to sharpen your skills, Taekwondo at Grit Fit is built for every level.",
