...
export function Footer() {
  return (
    <footer className="relative border-t border-border bg-ink-900">
      ...
      {/* Two text stacks (2 blocks high each) beside a full-height map */}
      <div className="container-grit grid gap-10 py-16 sm:grid-cols-2 md:grid-cols-[1fr_1fr_1.4fr] lg:gap-12">
        {/* Stack 1 — Grit Fit over Explore */}
        <div className="flex flex-col gap-12">
          <div className="flex flex-col gap-5">
            ...
            <Link
              ...
              className="btn btn-solid w-fit px-5 py-2.5"
            >
              {primaryCta.label}
            </Link>
          </div>
        ...
        {/* Location — fills the height of both stacks */}
        <MapSnippet
          variant="band"
